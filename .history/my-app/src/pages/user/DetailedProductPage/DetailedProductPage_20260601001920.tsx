  ...
  useEffect(() => {
    ...
    const fetchProduct = async () => {
      ...
      try {
        ...
        try {
          const [similarRecs, allProducts] = await Promise.all([
          ...
          setSimilarProducts(
            similarRecs
              ...
              .filter((p): p is ProductResponse => p != null && p.id !== id)
          );
        } catch {
          setSimilarError("Không thể tải sản phẩm tương tự");
        } finally {
