...
export default function UserHeader() {
  ...
  return (
      <>
        ...
        <header
            className="sticky top-0 w-full z-50 backdrop-blur-md bg-gradient-to-r from-[#ff8e53] via-[#ff9a5a] to-[#ffb347] border-b border-white/30 text-white shadow-lg"
        >
          <nav className="max-w-7xl mx-auto px-6">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="hidden md:flex items-center gap-4">
                ...
                <Link
                    to="/admin/login"
                    className="w-9 h-9 flex items-center justify-center rounded-full bg-white/20 hover:bg-white/40 transition text-lg"
                    title="Admin Login"
                >
                  🔐
                </Link>
