...
import { searchByImage, searchByText, type ImageSearchResult } from "../../../services/imageSearchService";
import ProductCard from "../ProductsPage/components/ProductCard";
import PetCard from "../PetsPage/components/PetCard";

type SearchMode = "upload" | "text";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500">
            Tải ảnh lên hoặc nhập mô tả để tìm sản phẩm/thú cưng tương tự
          </p>
        </div>
        ...
        {/* No results */}
        {!loading && !error && results.length === 0 && (previewUrl || textInput) && (
          <div className="text-center py-12">
